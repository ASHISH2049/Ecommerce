...
class t17 extends StatelessWidget
{
  @override
            ...
            children:<Widget> [
                        ...
                        children:<Widget> [
                          Row(
                            children: <Widget>[
                              ...
                              Container(
                                padding: EdgeInsets.fromLTRB(160.w, 20.h, 0, 0),
                                child: Text("dob"),
                              ),
                            ],
                          ),
                          Row(
                            children: <Widget>[
                              Container(
                                ...
                                child: Text("rahul Singh"),
                              ),

                              Container(
                                padding: EdgeInsets.fromLTRB(130.w, 0, 0, 0),
                                child: Text("04-06-1985"),
                              ),
                            ],
                          ),
                          Row(
                        ...
                        children:<Widget> [
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Align(
                                alignment: Alignment.centerRight,
                                child: Container(
                                  padding: EdgeInsets.fromLTRB(200.w, 10.h, 0, 0),
                                  child: Text("Seat no"),
                                ),
                              ),
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Container(
                                padding: EdgeInsets.fromLTRB(180.w, 0, 0, 0),
                                child: Text("6A,6B"),
                              ),
                            ],
                          ),
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  {
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context) => t18()));
                  },
